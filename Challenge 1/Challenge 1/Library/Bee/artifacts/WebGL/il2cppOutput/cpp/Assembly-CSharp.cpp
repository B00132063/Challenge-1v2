...
{
	// System.Single SpinPropellerX::propellerSpin
	float ___propellerSpin_4;
};
#ifdef __clang__
...
{
	{
		...
		float L_2 = __this->___propellerSpin_4;
		float L_3;
...
{
	{
		// private float propellerSpin = 1000;
		__this->___propellerSpin_4 = (1000.0f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
